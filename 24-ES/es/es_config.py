...
class ESConfig(SmartTrainerHub):
  ...
  alpha_region = Flag.float(1.0, '', is_key=None)
  alpha_lesion = Flag.float(1.0, '', is_key=None)
  alpha_total = Flag.float(1.0, '', is_key=None)
  model_num = Flag.integer(0, '', is_key=None)
